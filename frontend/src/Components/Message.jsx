...
export default function Message() {
  ...
  useEffect(() => {
    ...
    socket.current.on("chatMsg", handleMessage);
    return () => socket.current.off("chatMsg", handleMessage);
  }, []);
  ...
  return (
    <div className="w-full h-full md:w-xs md:h-[50%] bg-yellow-200 flex flex-col absolute bottom-0">
      ...
      <form
        method="POST"
        className="w-full h-auto bg-gray-200 p-4 flex"
